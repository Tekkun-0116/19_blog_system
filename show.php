...
<body>
  ...
  <div class="modal fade" id="post-delete" tabindex="-1" role="dialog"aia-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal"aia-label="Close">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">キャセ</button>
        <a href="delete.php?id=<?php echo h($post['id']); ?>" class="btn bn-warning">削除</a>
      </div>
    </div>
  </div>
</div>
